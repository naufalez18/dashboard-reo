...
```bash
git remote add encore encore://dashboard-rotation-app-yw82
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/dashboard-rotation-app-yw82/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/dashboard-rotation-app-yw82/settings/integrations/github)
