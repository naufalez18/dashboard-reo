 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_dashboard_create_create } from "~backend/dashboard/create";
...
export namespace dashboard {
    ...
    export class ServiceClient {
        ...
        public async create(params: RequestType<typeof api_dashboard_create_create>): Promise<ResponseType<typeof api_dashboard_create_create>> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/dashboards`, {headers, method: "POST", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_dashboard_create_create>
        }

        public async deleteDashboard(params: RequestType<typeof api_dashboard_delete_deleteDashboard>): Promise<void> {
            // Convert our params into the objects we need for the request
            const headers = makeRecord<string, string>({
                authorization: params.authorization,
            })
